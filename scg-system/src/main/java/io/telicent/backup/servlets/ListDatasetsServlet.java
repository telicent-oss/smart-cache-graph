...
/**
 * Servlet class responsible for listing available datasets for backup operations.
 */
public class ListDatasetsServlet extends HttpServlet {
    private final DatasetBackupService backupService;

    public ListDatasetsServlet(DatasetBackupService backupService) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            resultNode.set("datasets", backupService.listDatasets());
