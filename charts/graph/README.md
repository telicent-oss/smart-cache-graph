...
| Name                                          | Description                                                                                                                                                                                                                                                                                                                                                                     | Value                                                 |
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| `graph.routeToNamedGraphs`                    | Enable or disable routing to named graphs. When set to true, data will be routed into named graphs based on the Distribution-ID header set on the incoming Kafka events. This also enables the Distribution Lifecycle feature, setting the DISTRIBUTION_LIFECYCLE_ENABLED, DISTRIBUTION_LIFECYCLE_STATE_FILE and DISTRIBUTION_LIFECYCLE_LISTENER_THREADS environment variables. | `false`                                               |
| `graph.distributionLifecycle.stateFile`       | Path to the Distribution Lifecycle state file, which MUST be on a persistent volume. Only used when graph.routeToNamedGraphs is true.                                                                                                                                                                                                                                           | `/fuseki/databases/distribution-lifecycle-state.json` |
| `graph.distributionLifecycle.listenerThreads` | Number of threads used to fire Distribution Lifecycle listeners. MUST be greater than 1 so that a slow deletion does not block other listeners. Only used when graph.routeToNamedGraphs is true.                                                                                                                                                                                | `4`                                                   |
...
| `graph.simpleKnowledgeEnabled`                | Enable or disable the simple knowledge service. When set to true, an additional Fuseki service is exposed at `/simple-knowledge`, backed by its own ABAC secured TDB2 dataset, providing SPARQL query, GraphQL and Graph Store Protocol (read) endpoints.                                                                                                                       | `false`                                               |
